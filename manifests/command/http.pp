...
class nagios::command::http (
  ...
  $commands = {
    'check_http'                    => '$USER1$/check_http -k \'Accept: */*\' -H $HOSTADDRESS$ -I $HOSTADDRESS$',
    'check_https'                   => '$USER1$/check_http -k \'Accept: */*\' --ssl --sni -H $HOSTADDRESS$ -I $HOSTADDRESS$',
    'http_port'                     => '$USER1$/check_http -k \'Accept: */*\' -p $ARG1$ -H $HOSTADDRESS$ -I $HOSTADDRESS$',
    'check_http_url_content'        => '$USER1$/check_http -k \'Accept: */*\' -H $ARG1$ -u $ARG2$ -s $ARG3$ -f $ARG4$',
    'check_http_port_url_content'   => '$USER1$/check_http -k \'Accept: */*\' -H $ARG1$ -p $ARG2$ -u $ARG3$ -s $ARG4$ -f $ARG5$',
    ...
    'check_http_code'               => '$USER1$/check_http -k \'Accept: */*\' -H $ARG1$ -u $ARG2$ -e $ARG3$',
    'check_http_port_code'          => '$USER1$/check_http -k \'Accept: */*\' -H $ARG1$ -p $ARG2$ -u $ARG3$ -e $ARG4$',
    ...
    'check_http_auth_content'       => '$USER1$/check_http -k \'Accept: */*\' -H $ARG1$ -u $ARG2$ -s $ARG3$ -a $ARG4$:$ARG5$ -f $ARG6$',
    'check_http_port_auth_content'  => '$USER1$/check_http -k \'Accept: */*\' -H $ARG1$ -p $ARG2$ -u $ARG3$ -s $ARG4$ -a $ARG5$:$ARG6$ -f $ARG7$',
